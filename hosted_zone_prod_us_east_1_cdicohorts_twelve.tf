...
module "subdomain_prod_us_east_1_cdicohorts_twelve" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "2.0.0"
  create  = true

  providers = {
    aws = aws.subdomain_prod_us_east_1_cdicohorts_twelve
  }

  zones = {
    "prod-us-east-1.${local.domain_cdicohorts_twelve}" = {
      tags = {
        cluster = "prod"
      }
    }
...
module "subdomain_zone_delegation_prod_us_east_1_cdicohorts_twelve" {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_prod_us_east_1_cdicohorts_twelve.route53_zone_name_servers,"prod-us-east-1.${local.domain_cdicohorts_twelve}")
    }
  ]

  depends_on = [module.subdomain_prod_us_east_1_cdicohorts_twelve]
}
